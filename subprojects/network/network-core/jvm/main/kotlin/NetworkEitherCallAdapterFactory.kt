...
public class NetworkEitherCallAdapterFactory(
    ...
    private fun ParameterizedType.getBodyTypes(): Pair<Type, Type> {
        val failureWrapperType: ParameterizedType =
            getParameterUpperBound(0, this) as ParameterizedType
        val errorType = getParameterUpperBound(0, failureWrapperType)
        val successWrapperType: ParameterizedType =
            getParameterUpperBound(1, this) as ParameterizedType
