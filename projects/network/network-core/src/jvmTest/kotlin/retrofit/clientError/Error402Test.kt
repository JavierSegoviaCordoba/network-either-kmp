...
internal class Error402Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 402`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 402`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
