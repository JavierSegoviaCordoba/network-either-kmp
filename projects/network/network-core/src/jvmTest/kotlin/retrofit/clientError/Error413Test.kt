...
internal class Error413Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 413`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 413`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
