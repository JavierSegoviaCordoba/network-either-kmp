...
internal class Error412Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 412`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 412`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
