...
internal class Error424Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 424`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 424`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
