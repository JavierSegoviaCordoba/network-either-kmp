...
internal class Error422Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 422`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 422`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
