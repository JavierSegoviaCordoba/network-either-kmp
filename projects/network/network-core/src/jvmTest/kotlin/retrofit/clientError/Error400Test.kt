...
internal class Error400Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 400`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 400`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
