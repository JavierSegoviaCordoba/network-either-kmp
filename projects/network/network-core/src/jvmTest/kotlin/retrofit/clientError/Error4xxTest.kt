...
internal class Error4xxTest : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 4xx`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 4xx`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
