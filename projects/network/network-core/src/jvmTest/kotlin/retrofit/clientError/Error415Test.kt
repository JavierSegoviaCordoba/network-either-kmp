...
internal class Error415Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 415`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 415`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
