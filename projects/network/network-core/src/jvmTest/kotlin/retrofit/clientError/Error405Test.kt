...
internal class Error405Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 405`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 405`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
