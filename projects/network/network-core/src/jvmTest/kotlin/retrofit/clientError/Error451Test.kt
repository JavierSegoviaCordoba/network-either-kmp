...
internal class Error451Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 451`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 451`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
