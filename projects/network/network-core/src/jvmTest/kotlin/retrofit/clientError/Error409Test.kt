...
internal class Error409Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 409`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 409`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
