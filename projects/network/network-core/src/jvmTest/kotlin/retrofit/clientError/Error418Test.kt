...
internal class Error418Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 418`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 418`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
