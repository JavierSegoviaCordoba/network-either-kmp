...
internal class Error404Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 404`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 404`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
