...
internal class Error403Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 403`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 403`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
