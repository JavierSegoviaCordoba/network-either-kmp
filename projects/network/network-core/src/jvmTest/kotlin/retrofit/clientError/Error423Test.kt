...
internal class Error423Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 423`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 423`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
