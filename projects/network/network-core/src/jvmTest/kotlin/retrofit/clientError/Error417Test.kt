...
internal class Error417Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 417`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 417`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
