...
internal class Error406Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 406`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 406`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
