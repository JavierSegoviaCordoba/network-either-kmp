...
internal class Error421Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 421`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 421`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
