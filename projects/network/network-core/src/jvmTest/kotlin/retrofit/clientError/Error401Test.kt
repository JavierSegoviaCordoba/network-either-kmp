...
internal class Error401Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 401`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 401`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
