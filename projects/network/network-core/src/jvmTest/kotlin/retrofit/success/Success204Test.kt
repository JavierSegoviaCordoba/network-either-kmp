...
internal class Success204Test : BaseNullTest<ErrorDTO>() {
    ...
    @Test fun `suspend call 204`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 204`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
