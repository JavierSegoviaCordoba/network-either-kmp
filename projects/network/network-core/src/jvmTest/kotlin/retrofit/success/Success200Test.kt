...
internal class Success200Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 200`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 200`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
