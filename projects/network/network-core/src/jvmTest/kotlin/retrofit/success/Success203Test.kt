...
internal class Success203Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 203`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 203`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
