...
internal class Success206Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 206`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 206`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
