...
internal class Success226Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 226`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 226`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
