...
internal class Success2xxTest : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 2xx`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 2xx`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
