...
internal interface DogService {
    ...
    @GET("dos")
    fun getDogAsync(): Deferred<NetworkEither<ErrorDTO, DogDTO>>

    @GET("dog")
    suspend fun getDog(): NetworkEither<ErrorDTO, DogDTO>

    @GET("dog")
    fun getDogWithoutBodyAsync(): Deferred<NetworkEither<ErrorDTO, Unit>>

    @GET("dog")
    suspend fun getDogWithoutBody(): NetworkEither<ErrorDTO, Unit>

    companion object {

        fun getService(httpUrl: HttpUrl, timeoutMillis: Long = 200): DogService = Retrofit.Builder().apply {
            baseUrl(httpUrl)
        ...
        private fun okHttpClient(timeoutMillis: Long) = OkHttpClient.Builder().apply {
