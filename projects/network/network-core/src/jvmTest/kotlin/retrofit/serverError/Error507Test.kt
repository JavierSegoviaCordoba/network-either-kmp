...
internal class Error507Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 507`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 507`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
