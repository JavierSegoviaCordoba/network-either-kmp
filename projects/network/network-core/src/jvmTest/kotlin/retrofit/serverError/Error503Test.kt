...
internal class Error503Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 503`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 503`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
