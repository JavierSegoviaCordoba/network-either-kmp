...
internal class Error505Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 505`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 505`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
