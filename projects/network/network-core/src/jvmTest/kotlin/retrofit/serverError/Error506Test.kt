...
internal class Error506Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 506`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 506`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
