...
internal class Error511Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 511`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 511`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
