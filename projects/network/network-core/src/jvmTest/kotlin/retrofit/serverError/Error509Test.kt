...
internal class Error509Test : BaseTest<ErrorDTO, DogDTO>() {
    ...
    @Test fun `suspend call 509`() = runTestBlocking { service.getDog() shouldBe expected }

    @Test
    fun `async call 509`() = runTestBlocking { service.getDogAsync().await() shouldBe expected }
}
